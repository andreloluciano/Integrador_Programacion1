...
lista_mejor_caso = list(range(5000))  # el orden no importa ya que ambos casos es n²
lista_peor_caso = list(range(5000, 0, -1))  # el orden no importa ya que ambos casos es n²
...
print(f"Selection Sort - Mejor o peor caso (O(n²)): {tiempo_mejor:.5f} segundos")
print(f"Selection Sort - Peor o mejor caso (O(n²)): {tiempo_peor:.5f} segundos")